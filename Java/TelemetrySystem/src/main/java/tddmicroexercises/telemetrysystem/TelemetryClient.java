...
public class TelemetryClient {
	...
	public String receive() {
		...
		if (invalidDiagnosticMessage()) {
			message = simulateReceivedMessage();
		} else {
	...
	private void resetDiagnosticMessage() {
	...
	private boolean invalidDiagnosticMessage() {
		return diagnosticMessageResult == null || "".equals(diagnosticMessageResult);
	}
}
